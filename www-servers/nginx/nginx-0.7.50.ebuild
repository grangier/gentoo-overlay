...
IUSE="addition debug fastcgi flv imap pcre perl ssl status sub webdav zlib syslog wsgi redis"
...
src_compile() {
	...
	use redis	&& myconf="${myconf} --add-module=${FILESDIR}/ngx_http_redis-0.2.0"
